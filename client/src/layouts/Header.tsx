...
export default function Header() {
  ...
  return (
    <header className="flex items-center bg-[#032541]  text-lg text-white">
      <Switch />
        ...
        <nav className="flex w-full items-center justify-start px-5">
          <div className="group relative p-4">
            ...
            <ul className="absolute -left-3 top-[calc(100%+10px)] -mt-3 hidden flex-col items-center rounded-lg bg-gray-100 group-hover:flex">
              {[
                { place: "/movies/popular", name: "Popular" },
                { place: "/movies/now-playing", name: "Now Playing" },
                { place: "/movies/upcoming", name: "Upcoming" },
                { place: "/movies/top-rated", name: "Top Rated" },
              ].map(({ place, name }) => {
                return (
                  <Link
                    to={place}
          ...
          <div className="group relative p-4">
            ...
            <ul className="absolute -left-3 top-[calc(100%+10px)] -mt-3 hidden flex-col items-center rounded-lg bg-gray-100 group-hover:flex">
              {[
                { place: "/tvshow/popular", name: "Popular" },
